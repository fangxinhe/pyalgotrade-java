        ...
        this.insertMatch = function(data, options) {
            ...
            if (data.completer && data.completer.insertMatch) {
                ...
                if (data.snippet)
                    ...
                    if (this.editor.commands.commands['exitStockSearch']) {
                        this.editor.execCommand("insertstring", data.caption || data); //Modify by Zhiguo.Chen in JDJR
                        strategy.closeStockSearch(this.editor);
                    } else {
...
ace.define("ace/autocomplete/text_completer",["require","exports","module","ace/range"], function(require, exports, module) {
    ...
    var splitRegex = /[^\w+$]/; //Modify By Zhiguo.chen
